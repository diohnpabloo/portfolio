...
export function Footer() {
    return (
        <footer className="bg-gray-800 text-white p-4 text-center border-none border-t-0">
            ...
            <p className="text-sm">
                &copy; {new Date().getFullYear()} <span className="text-purply-100">Diohn Pablo</span>
            </p>
        </footer>
    )
}